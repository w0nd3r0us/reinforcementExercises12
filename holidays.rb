...
p b = Cohort.new(Date.new(2018,05,14))
puts "First day: #{Date.new(2018,05,14)}\nLast day: #{b.last_day}"
puts b.weeks_of_cohort
puts b.class_days
puts "------------------------------"
puts "Is #{Date.new(2018,05,14)} a holiday?\n#{b.double_check_holiday(Date.new(2018,05,14))}"
puts "Is #{Date.new(2018,05,21)} a holiday?\n#{b.double_check_holiday(Date.new(2018,05,14))}"
puts "------------------------------"
puts b.coffee_code_days
